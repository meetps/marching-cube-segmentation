...
class fileIO():
	...
	img=mha.fileIO() # All the public parameters will be set to None
	img=mha.fileIO(input_file='img.mha')
	img=mha.fileIO(data=matrix, size=[512, 512, 80], spacing=[0.9, 0.9, 5], offset=[-240, -240, -160], data_type='short', direction_cosines=[1, 0, 0, 0, 1, 0, 0, 0, 1])
